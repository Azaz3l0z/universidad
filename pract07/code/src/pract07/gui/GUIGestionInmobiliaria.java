...
import fundamentos.*;
import pract07.modelo.Agente;
import pract07.modelo.Inmobiliaria;
import pract07.modelo.Piso;
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case VENDE_PISO:
				...
				// Venta de piso
				Agente agente = inmobiliaria.vendePiso(ref);
				if (agente == null) {
					mensaje("Error", "No existe ningun piso con esa referencia o \n" +
							"el piso no esta asignado a ningun agente");
				} else {
